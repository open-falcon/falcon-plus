...
func init() {
	...
	BinOf = map[string]string{
		...
		"alarm-manager": "./alarm-manager/bin/falcon-alarm-manager",
	}
	...
	cfgOf = map[string]string{
		...
		"alarm-manager": "./alarm-manager/config/cfg.json",
	}
	...
	ModuleApps = map[string]string{
		...
		"api":           "falcon-api",
		"alarm":         "falcon-alarm",
		"alarm-manager": "falcon-alarm-manager",
	}
	...
	logpathOf = map[string]string{
		...
		"alarm-manager": "./alarm-manager/logs/alarm-manager.log",
	}
