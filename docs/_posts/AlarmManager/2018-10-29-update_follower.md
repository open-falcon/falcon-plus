...
apiurl: '/api/v1/fault/:id/follower'
title: "Update follower of fault"
type: 'PUT'
...
* Action in query string can only be FOLLOW and UNFOLLOW.
* The followers in query string is divided by comma.
